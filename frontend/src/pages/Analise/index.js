                ...
                <PageContainer>
                    <div className="searchBox">
                        <form method="GET" action="/">
                            <input type="text" name="q" placeholder="Data inicial" />
                            <input type="text" name="q" placeholder="Data final" />
                            <select placeholder="Escolha o cliente">
                                <option>Maria</option>
                                <option>Antonio</option>
                            </select>
                            <select placeholder="Escolha o Vendedor">
                                <option>Celeste</option>
                                <option>Elaine</option>
                            </select>
                            <button onClick={`window.location.href="/"`}>Analisar</button>
                        </form>
                    </div>
                </PageContainer>
            </SearchArea>
